...
<body>
						...
						<div class="col-xs-6 col-md-3 text-center"
							...
							<img class="img-responsive" :src="mobile.imgurl"> <label>
								...
								<div class="row">
									...
									<input type="button" value="加入购物车" class="btn btn-warning text-left" @click="addCart(mobile)">
								</div>
							</label>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-xs-6 col-md-3 text-center" v-for="part in partList">
					<img class="img-responsive" :src="part.imgurl"> <label>
						...
						<p id="discount">{{part.discount}}</p>
						<div class="row">
							<p id="price">
							<h3 class="text-danger">
								<span>￥</span>{{part.price}}
							</h3>
							</p>
							<input type="button" value="加入购物车" class="btn btn-warning text-left" @click="addCart(part)">
						</div>
					</label>
				</div>
			</div>
	...
	<script type="text/javascript">
		var vue = new Vue({
			...
			methods : {
				addCart : function(item) {
					$.ajax({
						type:"GET",
						url:"http://localhost:8080/vivo/myindex/addCart",
		...
		$.get("http://localhost:8080/vivo/myindex/myindex",function(res){
			vue.mobileList = res;
		})
		$.post("http://localhost:8080/vivo/myindex/myindex1",function(res){
			vue.partList = res;
		})
	</script>
</body>
